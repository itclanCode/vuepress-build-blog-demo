...
实现效果图,如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/1-block.jpg" alt="块级元素水平居中" />
...
实现效果如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/2-float-center.png" alt="浮动元素水平居中" />
...
实现效果图示例:
<img class="custom"  src ="../images/css-article-imgs/1-center/3-box-pack-center.png" alt="旧版弹性盒模型flex-box-pack-center" />
...
示例效果如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/4-just-content.png" alt="新版的flex布局just-content实现居中" />
...
示例效果如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/5-transform.png" alt="transform实现水平居中" />
...
示例效果如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/6-margin-left.png" alt="margin负半值" />
...
实例效果图如下所示
<img class="custom"  src ="../images/css-article-imgs/1-center/7-top-left-right-bottom.png" alt="top-right-left-bottom都为零" />
